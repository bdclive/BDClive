# ====================================================================
# THREADS LAB BRIDGE - NATIVE WINDOWS DESKTOP GUI EDITION (v1.0.36)
# ====================================================================
...
def send_rsvp_card(ev_id, ev_name, date_str, time_str, user_count, names_list):
    ...
    t_val = time_str if (time_str and time_str != "TBD") else "7:00 PM"
    payload = {
        "content": "",
        "embeds": [{
            "title": "🎟️  BRIAN'S THEATER — MOVIE NIGHT PASS",
            "description": f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n🎬 **FEATURED MOVIE:**  **{ev_name.upper()}**\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬",
            "color": 15844367,
            "fields": [
                {
                    "name": "📅 SHOWTIME",
                ...
                {
                    "name": "👥 ATTENDANCE",
                    "value": f"🎟️ **{user_count} {count_label} RSVP'd**\nSTATUS: **Live Confirmed**",
                    "inline": True
                },
                {
                    "name": "📜 CONFIRMED ATTENDEES ROSTER",
                    "value": f"{roster_text}\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬",
                    "inline": False
                }
            ],
            "footer": {
                "text": "Brian's Theater • Official Live RSVP Tracker v1.0.36"
            }
        }]
    }
...
# ====================================================================
# THREADS LAB BRIDGE - NATIVE WINDOWS DESKTOP GUI EDITION (v1.0.15)
# ====================================================================

SNAPCHAT_BEARER_TOKEN = "Bearer hCgwKCjE3ODQ1MDkyMDkSqwGosRJwFmrN_3fCeQ7XqMaUisDQQMfiKFeDmfjkMZJ-KXBPAH3B8a5yxqaE0FHrGY_Hqp5l6-BZLXTDHT5sUG2-vRGJoaD9veLvBn3diAAYHi74ohvZ2FDxcP25RW1apdfUcBV0OG-gGR3gduxgxjmyvXbD_21cUk6yXI9O0xeqPMHK4-dc_vqjuD0T_vEkgnzNcSHIm7jDDM2uOiFRcjJFkLAy0xxBaF3QNuw"

def get_snapchat_data(username="briandivacox"):
    subscribers, views = "3303", "1200"
    try:
        url = "https://gcp.api.snapchat.com/gfg/?op=PublicProfileSubscriberCount"
        headers = {
            "User-Agent": "Mozilla/5.0 (Linux; Android 15; Pixel 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Mobile Safari/537.36",
            "Authorization": SNAPCHAT_BEARER_TOKEN,
            "Content-Type": "application/json",
            "Origin": "https://profile.snapchat.com",
            "Referer": "https://profile.snapchat.com/",
            "apollographql-client-name": "profileMgr",
            "apollographql-client-version": "d541357f",
        ...
        if r.status_code == 200:
            res_json = r.json()
            cnt = res_json.get("data", {}).get("publicProfile", {}).get("subscriberCount")
    ...
    try:
        ...
        r_pub = session.get(url_pub, timeout=5)
...
def push_to_firebase(plex_count, chatters, viewers, fb_count, ig_count, threads_count, threads_views, yt_sub, tt_fol, x_fol, snap_fol="0", discord_rsvp="0", fb_personal="10467", fb_views="0", ig_views="0", yt_views="305291", snap_views="1200"):
    try:
        payload = {
            ...
            "fbPage": str(fb_count),
            "fbPersonal": str(fb_personal),
            "fbViews": str(fb_views),
            "igFol": str(ig_count),
            "igViews": str(ig_views),
            "threadsFol": str(threads_count),
            "threadsViews": str(threads_views),
            "ytSub": str(yt_sub),
            "ytViews": str(yt_views),
            "ttFol": str(tt_fol),
            "xFol": str(x_fol),
            "snapFol": str(snap_fol),
            "snapViews": str(snap_views)
        }
...
class BridgeGUIApp:
    def __init__(self, root):
        self.root = root
        self.root.title("🎬 Brian's Theater — Bridge Control Panel v1.0.36")
        ...
        while self.running:
            try:
                ...
                if now - last_meta >= META_INTERVAL or last_meta == 0:
                    ...
                    # Calculate & Update Grand Totals Card on GUI
                    ...
                    ig_v_val = int(ig_v) if str(ig_v).isdigit() else 5342
                    th_v_val = 6600
                    fb_v_val = int(fb_v) if str(fb_v).isdigit() else 8051
                    yt_v_val = int(yt_v) if str(yt_v).isdigit() else 305291
                    snap_v_val = int(snap_v) if str(snap_v).isdigit() else 1200

                    gt_views_sum = ig_v_val + th_v_val + fb_v_val + yt_v_val + snap_v_val
