# ====================================================================
# THREADS LAB BRIDGE - NATIVE WINDOWS DESKTOP GUI EDITION (v1.0.37)
# ====================================================================
    ...
    payload = {
        ...
        "embeds": [{
            ...
            "fields": [
                ...
                {
                    "name": "👥 ATTENDANCE",
                    "value": f"👥 **RSVPs:** {user_count} {count_label}",
                    "inline": True
                },
                {
            ...
            "footer": {
                "text": "Brian's Theater • Official Live RSVP Tracker v1.0.37"
            }
        }]
    }
...
class BridgeGUIApp:
    def __init__(self, root):
        self.root = root
        self.root.title("🎬 Brian's Theater — Bridge Control Panel v1.0.37")
