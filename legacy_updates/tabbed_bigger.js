...
if (html.includes(oldTabbedHTML)) {
    ...
    html = html.replace('<title>Cloud Dashboard v10.1.29</title>', '<title>Cloud Dashboard v10.1.30</title>');
    
    let changelog = `        /* 📝 Changelog v10.1.30 / Massive Tabbed Counters
    ...
    html = html.replace('        /* 📝 Changelog v10.1.29', changelog);
