...
const newTabbedHTML = `            <div id="social-tab-content" style="position: relative; width: 100%; height: 100%; background: #000; overflow: hidden;">
                <div id="tab-yt" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; display: flex; justify-content: center; align-items: center;">
                    <div style="transform: scale(1.3) translateX(45px) translateY(10px); transform-origin: center center; width: 450px; height: 220px; position: relative;">
                        <iframe scrolling="no" src="https://livecounts.io/embed/youtube-live-subscriber-counter/UCMuv7PfbLVm8IZsd6Bgqqzg" style="filter: invert(1) hue-rotate(180deg); border: 0; width: 450px; height: 220px; pointer-events: none; position: absolute; left: -140px; top: 15px; clip-path: inset(0px 0px 70px 0px);"></iframe>
                    </div>
                </div>
                <div id="tab-tt" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; display: none; justify-content: center; align-items: center;">
                    <div style="transform: scale(1.3) translateX(45px) translateY(10px); transform-origin: center center; width: 450px; height: 220px; position: relative;">
                        <iframe scrolling="no" src="https://livecounts.io/embed/tiktok-live-follower-counter/briandivacox" style="filter: invert(1) hue-rotate(180deg); border: 0; width: 450px; height: 220px; pointer-events: none; position: absolute; left: -140px; top: 15px; clip-path: inset(0px 0px 70px 0px);"></iframe>
                    </div>
                </div>
                <div id="tab-x" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; display: none; justify-content: center; align-items: center;">
                    <div style="transform: scale(1.3) translateX(45px) translateY(10px); transform-origin: center center; width: 450px; height: 220px; position: relative;">
                        <iframe scrolling="no" src="https://livecounts.io/embed/twitter-live-follower-counter/briandivacox" style="filter: invert(1) hue-rotate(180deg); border: 0; width: 450px; height: 220px; pointer-events: none; position: absolute; left: -140px; top: 15px; clip-path: inset(0px 0px 70px 0px);"></iframe>
                    </div>
                </div>
            </div>`;
...
if (html.includes(oldTabbedHTML)) {
    ...
    html = html.replace('<title>Cloud Dashboard v10.1.31</title>', '<title>Cloud Dashboard v10.1.32</title>');
    
    let changelog = `        /* 📝 Changelog v10.1.32 / Perfectly Aligned Pure Numbers
    ...
    html = html.replace('        /* 📝 Changelog v10.1.31', changelog);
