...
if (html.includes(oldTabbedHTML)) {
    ...
    html = html.replace('<title>Cloud Dashboard v10.1.32</title>', '<title>Cloud Dashboard v10.1.33</title>');
    
    let changelog = `        /* 📝 Changelog v10.1.33 / Natural Scaling
    ...
    html = html.replace('        /* 📝 Changelog v10.1.32', changelog);
